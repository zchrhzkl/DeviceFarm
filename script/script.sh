...
docker exec -ti appium adb logcat -c
docker exec -ti appium adb install -r app/test/robotframework/res/app.apk
docker exec -ti appium robot app/test/robotframework/Feature
